...
parser.add_argument('--POI', help='use this parameter of interest', default='MT/10')
parser.add_argument("--POIname", default="m_{ t}")
...
axishist.GetXaxis().SetTitle("%s [GeV]" % fixed_name)
